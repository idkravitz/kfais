...
insert into ranks(name) values ('7 кю');
insert into ranks(name) values ('6 кю');
insert into ranks(name) values ('5 кю');
insert into ranks(name) values ('4 кю');
insert into ranks(name) values ('3 кю');
insert into ranks(name) values ('2 кю');
insert into ranks(name) values ('1 кю');
insert into ranks(name) values ('10 дан');
insert into ranks(name) values ('9 дан');
insert into ranks(name) values ('8 дан');
insert into ranks(name) values ('7 дан');
insert into ranks(name) values ('6 дан');
insert into ranks(name) values ('5 дан');
insert into ranks(name) values ('4 дан');
insert into ranks(name) values ('3 дан');
insert into ranks(name) values ('2 дан');
insert into ranks(name) values ('1 дан');

/***************************************************************************************************/
/************************************ Must be delete in release ************************************/
/***************************************************************************************************/
